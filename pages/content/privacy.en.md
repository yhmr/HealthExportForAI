...
**Health Export For AI** (hereinafter referred to as "this app") respects your privacy and strives to protect your personal information.
...
This app uses **Google Sign-In** to access your Google Drive.

- **Purpose of use:** To save the exported health data files to your Google Drive.
- **Data sharing:** User account information is processed only within the app and on Google's servers, and is not visible to the developer.
...
If you have any questions regarding this Privacy Policy, please contact us via [GitHub Issues](https://github.com/yhmr/HealthExportForAI/issues).
