...
describe('Export Utils', () => {
  ...
  describe('getExportFileSearchName', () => {
    it('should be consistent with getExportFileName', () => {
      ...
      expect(getExportFileSearchName(year, extension, useUnderscore)).toBe(
        getExportFileName(year, extension, useUnderscore)
      );
    });
  });
  ...
  describe('Date Range Utils', () => {
    const mockHealthData: HealthData = {
      ...
      totalCaloriesBurned: [],
      basalMetabolicRate: [],
      sleep: [{ date: '2025-01-03', durationMinutes: 480, deepSleepPercentage: 20 }],
      nutrition: [],
      exercise: []
    };
  ...
  describe('formatHealthDataToRows', () => {
    const mockHealthData: HealthData = {
      ...
      weight: [{ date: '2025-01-01', value: 70.5, unit: 'kg', time: '08:00' }],
      bodyFat: [],
      totalCaloriesBurned: [],
      basalMetabolicRate: [],
      sleep: [{ date: '2025-01-02', durationMinutes: 450, deepSleepPercentage: 25 }],
      nutrition: [],
      exercise: [
